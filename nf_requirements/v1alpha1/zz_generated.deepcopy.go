...
func (in *InterfaceStatus) DeepCopyInto(out *InterfaceStatus) {
	*out = *in
	if in.IPClaimStatus != nil {
		in, out := &in.IPClaimStatus, &out.IPClaimStatus
		*out = make([]ipamv1alpha1.IPClaimStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.VLANClaimStatus != nil {
		in, out := &in.VLANClaimStatus, &out.VLANClaimStatus
		*out = new(vlanv1alpha1.VLANClaimStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *PoolStatus) DeepCopyInto(out *PoolStatus) {
	*out = *in
	in.IPClaim.DeepCopyInto(&out.IPClaim)
}
