...
func (in *CapacitySpec) DeepCopyInto(out *CapacitySpec) {
	*out = *in
	if in.MaxUplinkThroughput != nil {
		in, out := &in.MaxUplinkThroughput, &out.MaxUplinkThroughput
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.MaxDownlinkThroughput != nil {
		in, out := &in.MaxDownlinkThroughput, &out.MaxDownlinkThroughput
		x := (*in).DeepCopy()
		*out = &x
	}
	...
	if in.MaxSubscribers != nil {
		in, out := &in.MaxSubscribers, &out.MaxSubscribers
		*out = new(int)
		**out = **in
	}
	if in.MaxNFConnections != nil {
		in, out := &in.MaxNFConnections, &out.MaxNFConnections
		*out = new(uint16)
		**out = **in
	}
}
