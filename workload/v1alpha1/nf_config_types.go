...
type NFConfig struct {
	...
	Spec   NFConfigSpec   `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status NFConfigStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

type NFConfigSpec struct {
