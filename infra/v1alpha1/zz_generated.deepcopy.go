...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NephioClusterPackageConfig) DeepCopyInto(out *NephioClusterPackageConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NephioClusterPackageConfig.
func (in *NephioClusterPackageConfig) DeepCopy() *NephioClusterPackageConfig {
	if in == nil {
		return nil
	}
	out := new(NephioClusterPackageConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NephioClusterPackageConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NephioClusterPackageConfigList) DeepCopyInto(out *NephioClusterPackageConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NephioClusterPackageConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NephioClusterPackageConfigList.
func (in *NephioClusterPackageConfigList) DeepCopy() *NephioClusterPackageConfigList {
	if in == nil {
		return nil
	}
	out := new(NephioClusterPackageConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NephioClusterPackageConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NephioClusterPackageConfigSpec) DeepCopyInto(out *NephioClusterPackageConfigSpec) {
	*out = *in
	if in.NephioCatalogRepo != nil {
		in, out := &in.NephioCatalogRepo, &out.NephioCatalogRepo
		*out = new(string)
		**out = **in
	}
	if in.NephioMgmtRepo != nil {
		in, out := &in.NephioMgmtRepo, &out.NephioMgmtRepo
		*out = new(string)
		**out = **in
	}
	if in.NephioStagingRepo != nil {
		in, out := &in.NephioStagingRepo, &out.NephioStagingRepo
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NephioClusterPackageConfigSpec.
func (in *NephioClusterPackageConfigSpec) DeepCopy() *NephioClusterPackageConfigSpec {
	if in == nil {
		return nil
	}
	out := new(NephioClusterPackageConfigSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NephioClusterPackageConfigStatus) DeepCopyInto(out *NephioClusterPackageConfigStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NephioClusterPackageConfigStatus.
func (in *NephioClusterPackageConfigStatus) DeepCopy() *NephioClusterPackageConfigStatus {
	if in == nil {
		return nil
	}
	out := new(NephioClusterPackageConfigStatus)
	in.DeepCopyInto(out)
	return out
}
